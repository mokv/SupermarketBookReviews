...
namespace Supermarket.MVC
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,ISBN,Author")] Book book)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(GlobalConstants.AdminPolicy)]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,ISBN,Author")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
